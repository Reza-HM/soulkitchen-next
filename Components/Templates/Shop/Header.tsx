  ...
  return (
    <div className="flex justify-start items-center p-32 h-screen bg-[url('/img/shop1.jpg')] bg-cover bg-center bg-no-repeat">
      <div className="flex flex-col items-start gap-16">
        ...
        <h1 className="font-PlayfairDisplay text-8xl font-semibold tracking-wide dark:text-zinc-600">
          Soul Kitchen to go
        </h1>
        ...
        <Link
          href="/allProducts"
          className="w-80 bg-black text-zinc-400 dark:bg-zinc-500 dark:text-white hover:bg-zinc-500 hover:text-white duration-300 flex justify-center items-center p-4 rounded-xl"
        >
          SEE ALL PRODUCTS
        </Link>
      </div>
